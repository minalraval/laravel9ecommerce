                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                           ...
                           <form wire:submit.prevent="updateProduct()">
                                ...
                                <div class="mb-3 mt-3">
                                    <label for="quantity" class="form-label">SKU</label>
                                    <input type="text" name="quantity" class="form-control" placeholder="Enter sku" wire:model="sku" />
                                    @error('sku')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="sku" class="form-control" placeholder="Enter product quantity" wire:model="quantity" />
                                    @error('quantity')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
