                        ...
                        <div class="card-body">
                           ...
                           <form wire:submit.prevent="updateSlide()">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="" class="form-control" placeholder="Enter slide top title" wire:model="top_title"/>
                                    @error('top_title')
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="slug" class="form-control" placeholder="Enter  slide sub title" wire:model="sub_title" />
                                    @error('sub_title')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="slug" class="form-control" placeholder="Enter  slide link" wire:model="link" />
                                    @error('link')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
